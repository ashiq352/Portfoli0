...
function Index({ secRef }) {
    ...
    const Skills = {
        all: [{ logo: reactjs, name: "React JS" }, { logo: javascript, name: "JavaScript" }, { logo: css, name: "CSS3" }, { logo: html, name: "HTML5" }, { name: "Bootstrap", logo: bootstrap }, { logo: nodejs, name: "Node JS" }, { logo: mongodb, name: "Mongo DB" }, { logo: heroku, name: "Heroku" }, { logo: git, name: "Git" }],
        frontend: [{ logo: reactjs, name: "React JS" }, { logo: javascript, name: "JavaScript" }, { logo: css, name: "CSS3" }, { logo: html, name: "HTML5" }, { name: "Bootstrap", logo: bootstrap }],
        backend: [{ logo: nodejs, name: "Node JS" }, { logo: mongodb, name: "Mongo DB" }],
        database: [{ logo: mongodb, name: "Mongo DB" }],
        cloud: [{ logo: azure, name: "Azure" }, { logo: heroku, name: "Heroku" }, { logo: mongodb, name: "Mongo DB" }],
        others: [{ logo: git, name: "Git" }]
    }
